...
for( let i = 0; i < coursesAndDurationArray.length; i += 1){
    ...
    duration.innerText = `Duration: ${coursesAndDurationArray[i].monthDuration} months`
...
for(let i = 0; i < simpsons.length; i += 1){
    let member = document.createElement("div");
    member.classList.add("member");
    let photo = document.createElement("img");
    photo.href = simpsons[i].photo;
    photo.alt = `${simpsons[i].name} ${simpsons[i].surname}`;
    member.appendChild(photo);
    let name = document.createElement("h2");
    name.innerText = `Full name: ${simpsons[i].name} ${simpsons[i].surname}`
    name.classList.add("fullName");
    member.appendChild(name);
    let description = document.createElement("p");
    description.classList.add("simpsonDescription");
    description.innerText = `Age: ${simpsons[i].age} \n ${simpsons[i].info}`;
...
for( let i = 0; i < coursesArray.length; i += 1){
    ...
    course.appendChild(title);
    let duration = document.createElement("p");
    duration.innerText = `Duration: ${coursesArray[i].monthDuration} months (${coursesArray[i].hourDuration} hours)`
    course.appendChild(duration);
    let modules= document.createElement("div");
    let moduleText = document.createElement("h2");
    moduleText.innerText = "Modules: ";
    modules.appendChild(moduleText);
    for(let j=0; j < coursesArray[i].modules.length; j += 1){
